...
export default ({scope, ...props}) => {
	...
	const newAppLink = compile(props.editPath)();
	...
	const emptyState = {
		button: () => (
			<Button
				...
				tooltip={Liferay.Language.get(
					'create-an-app-driven-by-workflow-process'
				)}
			>
		...
		description: Liferay.Language.get(
			'workflow-powered-are-apps-driven-by-workflow-process'
		),
		title: Liferay.Language.get('no-workflow-powered-apps-yet'),
	};
