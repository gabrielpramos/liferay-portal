...
import DeploySettingsModal from './DeploySettingsModal.es';
import {
	getAssigneeRoles,
	getDataObjects,
	getFormViews,
				...
				<EditAppContext.Provider value={editState}>
					<UpperToolbar>
						...
						<UpperToolbar.Group>
							...
							<UpperToolbar.Button
								disabled={
									!canDeployApp(app, config) || isSaving
								}
								displayType="secondary"
								onClick={onClickSave}
							>
					...
					<DeploySettingsModal onCancel={onCancel} />
