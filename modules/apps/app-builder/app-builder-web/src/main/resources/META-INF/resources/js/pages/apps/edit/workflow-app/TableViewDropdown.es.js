...
export default ({customObjectId}) => {
	...
	const {id: tableViewId, name: tableViewName} = selectedValue;

	const ENDPOINT_TABLE_VIEWS = `/o/data-engine/v2.0/data-definitions/${customObjectId}/data-list-views`;

	const {
		response: {items = []},
	} = useRequest(ENDPOINT_TABLE_VIEWS);
				...
				trigger={
					...
					>
						<span className="float-left">
							{tableViewName ||
								Liferay.Language.get('select-table-view')}
						</span>
